...
class _GroupMasterExportModalDialogState extends State<_GroupMasterExportModalDialog> {
  ...
  Future<void> _finalizeFileAndComplete() async {
    ...
    try {
      ...
      if (_selectedFormat == 'XLSX') {
        filePath = '$downloadsPath\\Group_Master_Export_$timeStamp.xlsx';
        await _generateExcelFile(filePath, selectedList);
      } else {
        filePath = '$downloadsPath\\Group_Master_Export_$timeStamp.pdf';
  ...
  Future<void> _generateExcelFile(String filePath, List<GroupMasterItem> records) async {
  ...
  Future<void> _generatePdfFile(String filePath, List<GroupMasterItem> records) async {
