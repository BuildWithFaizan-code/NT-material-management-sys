...
class _FabricSizeExportModalDialogState extends State<_FabricSizeExportModalDialog> {
  ...
  Future<void> _finalizeFileAndComplete() async {
    ...
    try {
      ...
      if (_selectedFormat == 'XLSX') {
        filePath = '$downloadsPath\\Fabric_Size_Master_$timeStamp.xlsx';
        await _generateExcelFile(filePath, selectedList);
      } else {
        filePath = '$downloadsPath\\Fabric_Size_Master_$timeStamp.pdf';
  ...
  Future<void> _generateExcelFile(String filePath, List<FabricSizeItem> records) async {
  ...
  Future<void> _generatePdfFile(String filePath, List<FabricSizeItem> records) async {
